...
- [x] Phase 32: Video qua YouTube (ADR-022 — resource video lưu `youtube_id`, viewer embed YouTube không tốn storage; quota/user 250 MB; ADR-023 — kho video trung tâm qua YouTube Data API v3 + Google OAuth, tiêu đề `[User | Tbz cloud | tên file]`, connect admin-only; ADR-024 — đăng nhập bằng Google)
