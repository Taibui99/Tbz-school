...
- [x] Phase 32: Video qua YouTube (ADR-022 — resource video lưu `youtube_id`, viewer embed YouTube không tốn storage; quota/user 250 MB; ADR-023 — auto-upload qua YouTube Data API v3 + Google OAuth, token lưu server-side `google_oauth`)
